...
let
  ...
  notFoundHTML = `
    ...
    <html>
      <head>
        <meta charset="utf-8">
        <title>SSR state hydration - JSON script</title>
      </head>
      <body>
...
let
  ...
  renderPage = () => `
    ...
    <html lang="en">
      ...
      <body>
        <h1>SSR state hydration example: JSON script</h1>
        ...
        <script id="table-data" type="application/json">${JSON.stringify(tableData)}</script>
      </body>
    </html>
  `,
